 ...
 * This file demonstrates how to integrate Agentgridpro with a web frontend
 */

// For React/Vue/Angular applications
export class AgentgridproClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AgentgridproClient(provider, contractAddress);

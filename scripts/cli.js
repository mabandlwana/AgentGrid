...
const contractABI = require("../artifacts/contracts/Agentgridpro.sol/Agentgridpro.json").abi;

program
    .name("agentgridpro-cli")
    .description("CLI tool for Agentgridpro smart contract")
    .version("1.0.0");
